...
import com.example.studykotlin.databinding.ActivityBoxSelectionBinding
import com.example.studykotlin.databinding.ItemBoxBinding
...
class BoxSelectionActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        boxIndex = savedInstanceState?.getInt(KEY_INDEX) ?: Random.nextInt(0, options.boxCount)
